                        ...
                        <ul class="divide-y divide-gray-200 w-full">
                            ...
                            @forelse($vacante->candidatos as $candidato)
                                <li class="p-3 flex items-center border-b">
                                    ...
                                    <div>
                                        <a
                                            class="inline-flex items-center shadow-sm px-3 py-0.5 border border-gray-300 text-sm leading-5 font-medium rounded-full text-gray-700 bg-white hover:bg-gray-50"
                            ...
                            @empty
                                <li class="p-3 text-center text-sm text-gray-600">No hay candidatos en la vacante!!!</li>
                            @endforelse
                        </ul>
                    </div>
                </div>
